 ...
 */
package com.deepexi.daqiutest.aop;

import com.alibaba.fastjson.JSON;
import com.deepexi.daqiutest.extension.AppRuntimeEnv;
...
public class LogAspect {
    ...
    @Pointcut("execution (* com.deepexi.daqiutest.controller..*.*(..))")
    public void controllerLogAop() {
    }

    @Pointcut("execution (* com.deepexi.daqiutest.service..*.*(..))")
