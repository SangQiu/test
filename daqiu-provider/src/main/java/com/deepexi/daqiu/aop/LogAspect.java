 ...
 */
package com.deepexi.daqiu.aop;

import com.alibaba.fastjson.JSON;
import com.deepexi.daqiu.extension.AppRuntimeEnv;
...
public class LogAspect {
    ...
    @Pointcut("execution (* com.deepexi.daqiu.controller..*.*(..))")
    public void controllerLogAop() {
    }

    @Pointcut("execution (* com.deepexi.daqiu.service..*.*(..))")
